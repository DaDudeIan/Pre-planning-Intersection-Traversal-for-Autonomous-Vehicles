...
#term-table(
  ...
  [Function], [A self-contained block of code that performs a specific task and can be called by name.],
  [Stack], [Also called a suite, a stack is a collection of related functions.],
  [Parameter], [A variable used to define a system or function.],
