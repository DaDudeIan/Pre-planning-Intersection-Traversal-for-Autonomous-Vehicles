...
For this project, two of the most widely used transformer-based models were chosen, the Vision Transformer (ViT) and the Swin Transformer. The ViT was presented in detail in @c2s2.2.1:cv, highlighting it being the first connection of the NLP method called Attention and computer vision.
