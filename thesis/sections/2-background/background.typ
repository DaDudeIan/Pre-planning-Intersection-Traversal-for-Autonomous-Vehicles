...
== Autonomous Vehicles #checked <c2s2.1:av>
...
The first commercially available adaptive cruise control (ACC) vehicles came from Chrysler in 1958 following the invention of the SpeedoStat @first_cc. They named this system the "Auto-Pilot" and vehicles equipped with it were some of the first vehicles in history to achieve what would later be called Level 1 autonomy. Soon after, Cadillac adopted the technology for their own vehicles and dubbed it "Cruise Control", which since became the default term for the ACC technology, which is still used today, though usually with the term "adaptive" prepended.
...
== Deep Learning #checked <c2s2.2:dl>
...
=== Computer Vision #checked <c2s2.2.1:cv>
...
=== Datasets #checked <c2s2.2.2:datasets>
...
== Satellite Imagery #checked <c2s2.3:si>
