...
for epoch in range(n_epochs):
    ...
    if (epoch + 1) % 10 == 0:
        print(f"Epoch {epoch + 1}/{n_epochs} | Train Loss: {running_train_loss / len(train_dataloader):.4f} | Train Accuracy: {running_train_correct / running_train_total:.4f} | Test Loss: {running_test_loss / len(test_dataloader):.4f} | Test Accuracy: {running_test_correct / running_test_total:.4f}")
