...
optimizer = AdamW(model.parameters(), lr=5e-5, weight_decay=2e-4)
#optimizer = Adam(model.parameters(), lr=1e-4, weight_decay=1e-4)


# ====================== Scheduler ======================

scheduler = CosineAnnealingWarmRestarts(optimizer, T_0=250, T_mult=2, eta_min=1e-6)
